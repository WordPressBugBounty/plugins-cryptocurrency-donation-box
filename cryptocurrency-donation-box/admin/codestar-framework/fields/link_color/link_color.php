...
if ( ! class_exists( 'CSF_Field_link_color' ) ) {
  class CSF_Field_link_color extends CSF_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'cryptocurrency-donation-box' ),
        'hover'    => esc_html__( 'Hover', 'cryptocurrency-donation-box' ),
        'active'   => esc_html__( 'Active', 'cryptocurrency-donation-box' ),
        'visited'  => esc_html__( 'Visited', 'cryptocurrency-donation-box' ),
        'focus'    => esc_html__( 'Focus', 'cryptocurrency-donation-box' )
      );
