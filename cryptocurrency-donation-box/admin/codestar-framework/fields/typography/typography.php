  ...
  class CSF_Field_typography extends CSF_Fields {
      ...
      echo '<div class="csf--typography'. esc_attr( $chosen_class ) .'" data-depend-id="'. esc_attr( $this->field['id'] ) .'" data-unit="'. esc_attr( $args['unit'] ) .'" data-line-height-unit="'. esc_attr( $line_height_unit ) .'" data-exclude="'. esc_attr( $args['exclude'] ) .'">';
        ...
        echo '<div class="csf--blocks csf--blocks-selects">';
          ...
          if ( ! empty( $args['font_family'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Font Family', 'cryptocurrency-donation-box' ) .'</div>';
            echo $this->create_select( array( $this->value['font-family'] => $this->value['font-family'] ), 'font-family', esc_html__( 'Select a font', 'cryptocurrency-donation-box' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['backup_font_family'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Backup Font Family', 'cryptocurrency-donation-box' ) .'</div>';
            echo $this->create_select( apply_filters( 'csf_field_typography_backup_font_family', array(
              ...
              'Georgia, serif',
              'Palatino Linotype'
            ) ), 'backup-font-family', esc_html__( 'Default', 'cryptocurrency-donation-box' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['font_weight'] ) || ! empty( $args['font_style'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Font Style', 'cryptocurrency-donation-box') .'</div>';
            echo '<select class="csf--font-style-select" data-placeholder="Default">';
            echo '<option value="">'. ( ! $this->chosen ? esc_html__( 'Default', 'cryptocurrency-donation-box' ) : '' ) .'</option>';
            ...
            if ( ! empty( $args['extra_styles'] ) ) {
              ...
              echo ( ! $this->chosen ) ? '<div class="csf--title">'. esc_html__( 'Load Extra Styles', 'cryptocurrency-donation-box' ) .'</div>' : '';
              $placeholder = ( $this->chosen ) ? esc_html__( 'Load Extra Styles', 'cryptocurrency-donation-box' ) : esc_html__( 'Default', 'cryptocurrency-donation-box' );
          ...
          if ( ! empty( $args['subset'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Subset', 'cryptocurrency-donation-box' ) .'</div>';
            $subset = ( is_array( $this->value['subset'] ) ) ? $this->value['subset'] : array_filter( (array) $this->value['subset'] );
            echo $this->create_select( $subset, 'subset', esc_html__( 'Default', 'cryptocurrency-donation-box' ), $args['multi_subset'] );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['text_align'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Text Align', 'cryptocurrency-donation-box' ) .'</div>';
            echo $this->create_select( array(
              'inherit' => esc_html__( 'Inherit', 'cryptocurrency-donation-box' ),
              'left'    => esc_html__( 'Left', 'cryptocurrency-donation-box' ),
              'center'  => esc_html__( 'Center', 'cryptocurrency-donation-box' ),
              'right'   => esc_html__( 'Right', 'cryptocurrency-donation-box' ),
              'justify' => esc_html__( 'Justify', 'cryptocurrency-donation-box' ),
              'initial' => esc_html__( 'Initial', 'cryptocurrency-donation-box' )
            ), 'text-align', esc_html__( 'Default', 'cryptocurrency-donation-box' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['font_variant'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Font Variant', 'cryptocurrency-donation-box' ) .'</div>';
            echo $this->create_select( array(
              'normal'         => esc_html__( 'Normal', 'cryptocurrency-donation-box' ),
              'small-caps'     => esc_html__( 'Small Caps', 'cryptocurrency-donation-box' ),
              'all-small-caps' => esc_html__( 'All Small Caps', 'cryptocurrency-donation-box' )
            ), 'font-variant', esc_html__( 'Default', 'cryptocurrency-donation-box' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['text_transform'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Text Transform', 'cryptocurrency-donation-box' ) .'</div>';
            echo $this->create_select( array(
              'none'       => esc_html__( 'None', 'cryptocurrency-donation-box' ),
              'capitalize' => esc_html__( 'Capitalize', 'cryptocurrency-donation-box' ),
              'uppercase'  => esc_html__( 'Uppercase', 'cryptocurrency-donation-box' ),
              'lowercase'  => esc_html__( 'Lowercase', 'cryptocurrency-donation-box' )
            ), 'text-transform', esc_html__( 'Default', 'cryptocurrency-donation-box' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['text_decoration'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Text Decoration', 'cryptocurrency-donation-box' ) .'</div>';
            echo $this->create_select( array(
              'none'               => esc_html__( 'None', 'cryptocurrency-donation-box' ),
              'underline'          => esc_html__( 'Solid', 'cryptocurrency-donation-box' ),
              'underline double'   => esc_html__( 'Double', 'cryptocurrency-donation-box' ),
              'underline dotted'   => esc_html__( 'Dotted', 'cryptocurrency-donation-box' ),
              'underline dashed'   => esc_html__( 'Dashed', 'cryptocurrency-donation-box' ),
              'underline wavy'     => esc_html__( 'Wavy', 'cryptocurrency-donation-box' ),
              'underline overline' => esc_html__( 'Overline', 'cryptocurrency-donation-box' ),
              'line-through'       => esc_html__( 'Line-through', 'cryptocurrency-donation-box' )
            ), 'text-decoration', esc_html__( 'Default', 'cryptocurrency-donation-box' ) );
            echo '</div>';
          }
        ...
        echo '<div class="csf--blocks csf--blocks-inputs">';
          ...
          if ( ! empty( $args['font_size'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Font Size', 'cryptocurrency-donation-box' ) .'</div>';
          ...
          if ( ! empty( $args['line_height'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Line Height', 'cryptocurrency-donation-box' ) .'</div>';
            echo '<div class="csf--input-wrap">';
          ...
          if ( ! empty( $args['letter_spacing'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Letter Spacing', 'cryptocurrency-donation-box' ) .'</div>';
            echo '<div class="csf--input-wrap">';
          ...
          if ( ! empty( $args['word_spacing'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Word Spacing', 'cryptocurrency-donation-box' ) .'</div>';
            echo '<div class="csf--input-wrap">';
        ...
        if ( ! empty( $args['color'] ) ) {
          ...
          echo '<div class="csf--title">'. esc_html__( 'Font Color', 'cryptocurrency-donation-box' ) .'</div>';
        ...
        if ( ! empty( $args['custom_style'] ) ) {
          ...
          echo '<div class="csf--title">'. esc_html__( 'Custom Style', 'cryptocurrency-donation-box' ) .'</div>';
    ...
    public function enqueue() {
      ...
      if ( ! wp_script_is( 'csf-webfontloader' ) ) {
        ...
        wp_enqueue_script( 'csf-webfontloader', 'https://cdn.jsdelivr.net/npm/webfontloader@1.6.28/webfontloader.min.js', array( 'cryptocurrency-donation-box' ), '1.6.28', true );
        ...
        if ( ! empty( $customwebfonts ) ) {
          $webfonts['custom'] = array(
            'label' => esc_html__( 'Custom Web Fonts', 'cryptocurrency-donation-box' ),
            'fonts' => $customwebfonts
          );
        }

        $webfonts['safe'] = array(
          'label' => esc_html__( 'Safe Web Fonts', 'cryptocurrency-donation-box' ),
        ...
        $webfonts['google'] = array(
          'label' => esc_html__( 'Google Web Fonts', 'cryptocurrency-donation-box' ),
        ...
        wp_localize_script( 'cryptocurrency-donation-box', 'csf_typography_json', array(
          'webfonts'      => $webfonts,
