...
class CMB2_JS {
	...
	protected static function colorpicker_frontend() {
		...
		wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
			'clear'         => esc_html__( 'Clear', 'cryptocurrency-donation-box' ),
			'defaultString' => esc_html__( 'Default', 'cryptocurrency-donation-box' ),
			'pick'          => esc_html__( 'Select Color', 'cryptocurrency-donation-box' ),
			'current'       => esc_html__( 'Current Color', 'cryptocurrency-donation-box' ),
		) );
	}
		...
		$l10n = array(
			...
			'defaults'          => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => _x( 'mm/dd/yy', 'Valid formatDate string for jquery-ui datepicker', 'cryptocurrency-donation-box' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'cryptocurrency-donation-box' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'cryptocurrency-donation-box' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'cryptocurrency-donation-box' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'cryptocurrency-donation-box' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'cryptocurrency-donation-box' ) ),
					'nextText'        => esc_html__( 'Next', 'cryptocurrency-donation-box' ),
					'prevText'        => esc_html__( 'Prev', 'cryptocurrency-donation-box' ),
					'currentText'     => esc_html__( 'Today', 'cryptocurrency-donation-box' ),
					'closeText'       => esc_html__( 'Done', 'cryptocurrency-donation-box' ),
					'clearText'       => esc_html__( 'Clear', 'cryptocurrency-donation-box' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'cryptocurrency-donation-box' ),
					'timeText'      => esc_html__( 'Time', 'cryptocurrency-donation-box' ),
					'hourText'      => esc_html__( 'Hour', 'cryptocurrency-donation-box' ),
					'minuteText'    => esc_html__( 'Minute', 'cryptocurrency-donation-box' ),
					'secondText'    => esc_html__( 'Second', 'cryptocurrency-donation-box' ),
					'currentText'   => esc_html__( 'Now', 'cryptocurrency-donation-box' ),
					'closeText'     => esc_html__( 'Done', 'cryptocurrency-donation-box' ),
					'timeFormat'    => _x( 'hh:mm TT', 'Valid formatting string, as per http://trentrichardson.com/examples/timepicker/', 'cryptocurrency-donation-box' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'cryptocurrency-donation-box' ),
				'upload_files' => esc_html__( 'Use these files', 'cryptocurrency-donation-box' ),
				'remove_image' => esc_html__( 'Remove Image', 'cryptocurrency-donation-box' ),
				'remove_file'  => esc_html__( 'Remove', 'cryptocurrency-donation-box' ),
				'file'         => esc_html__( 'File:', 'cryptocurrency-donation-box' ),
				'download'     => esc_html__( 'Download', 'cryptocurrency-donation-box' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'cryptocurrency-donation-box' ),
			),
		);
